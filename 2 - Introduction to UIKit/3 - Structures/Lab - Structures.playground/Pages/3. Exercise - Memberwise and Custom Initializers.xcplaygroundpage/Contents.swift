...
struct Laptop {
    ...
    var repaitCount: Int = 0
    var yearPurchased: Int
}

let first = Laptop(screenSize: 15, repaitCount: 2, yearPurchased: 2018)
let second = Laptop(yearPurchased: 2021)
...
let someonesHeight = Height(heightInInches: 65.0)
...
let myHeight = Height(heightInCentimeters: 163.0)
