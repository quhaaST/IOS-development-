...
let heartRate2D: Double = 75.0
let heartRate3D: Double = 81.0

let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)

// The result is different since we are applying division to a Double type, which supports float numbers
